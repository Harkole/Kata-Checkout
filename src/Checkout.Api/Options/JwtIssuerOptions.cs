...
namespace Checkout.Api.Options
{
    public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// The period of time to allow for clocks to be different between server and client
        /// </summary>
        ...
        ///   there is as small a probability as possible that the same value will be
        ...
        ///   as well.  The "jti" claim can be used to prevent the JWT from being replayed.
        ///   The "jti" value is a case-sensitive string.  Use of this claim is OPTIONAL.</remarks>
        ...
        /// <summary>
        /// The secret used to generate the token and validate it later
        /// </summary>
